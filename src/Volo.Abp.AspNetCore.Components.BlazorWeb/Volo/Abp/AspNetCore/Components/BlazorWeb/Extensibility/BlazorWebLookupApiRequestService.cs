...
public class BlazorWebLookupApiRequestService : ILookupApiRequestService, ITransientDependency
{
    ...
    public BlazorWebLookupApiRequestService(IHttpClientFactory httpClientFactory,
    ...
    {
        var client = HttpClientFactory.CreateClient(nameof(BlazorWebLookupApiRequestService));
