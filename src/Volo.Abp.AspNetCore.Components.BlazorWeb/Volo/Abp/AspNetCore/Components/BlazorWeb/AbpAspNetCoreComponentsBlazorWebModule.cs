...
namespace Volo.Abp.AspNetCore.Components.BlazorWeb;
...
public class AbpAspNetCoreComponentsBlazorWebModule : AbpModule
{
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services.AddHttpClient(nameof(BlazorWebLookupApiRequestService))
        ...
        Configure<AbpEndpointRouterOptions>(options =>
        {
            ...
            {
                // endpointContext.Endpoints.MapRazorComponents<App>()
