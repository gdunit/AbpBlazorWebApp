...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p ea80e202-5526-479e-b381-b21460db4382
```

> `ea80e202-5526-479e-b381-b21460db4382` is the password of the certificate, you can change it to any password you want.
